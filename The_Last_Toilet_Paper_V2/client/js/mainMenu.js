...
GameStates.menuState = function (game, shared) {
    ...
    return {
        ...
        create: function () {
            ...
            title = game.add.text(20, game.world.centerY - 140, "The Last Toilet Paper", { font: "50px Arial", fill: "#ff0044", align: "left" });
            //option1 = game.add.text(110, game.world.centerY - 50, "How To Play", { font: "30px Arial", fill: "#ff0044", align: "left" });
